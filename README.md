...
## Using Vibe-Crafting Skill:

I maintain my agent-skill for this style of development in the [/skill folder](/skill) of this repo. Download that folder to your `.skills` folder to enable the `/spec` skill in your IDE/TUI of choice.
