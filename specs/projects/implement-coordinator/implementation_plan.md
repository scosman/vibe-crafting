...
- [ ] Phase 2: Supporting files and validation — Update `spawning_subagents.md` with the resume pattern, verify `cr_agent_prompt.md` needs no changes, then cross-reference audit and consistency check across all four files.
